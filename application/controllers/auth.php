...
class Auth extends CI_Controller
{
	...
	function username_check($username)
	{
		...
		if ( ! $result)
		{
			$this->form_validation->set_message('username_check', alert('warning', '', 'Username already taken'));
		}
	...
	function email_check($email)
	{
		...
		if ( ! $result)
		{
			$this->form_validation->set_message('email_check', alert('warning', '', 'Email already taken'));
		}
...
/*
	...
	*/
	...
	function login()
	{
		if ( ! $this->dx_auth->is_logged_in())
		{
			...
			else
			{
				...
				{						
                    ...
                    $data['page_title_desc'] = 'Here you must login to view the website'; // Capitalize the first letter
		...
		{
			$data['auth_message'] = alert('warning', '', 'You are already signed in');
	...
	function logout()
	{
        ...
        $data['auth_message'] = alert('success', '', 'You have been logged out');

        $data['title'] = 'Logout'; // Capitalize the first letter
        $data['page_title'] = 'Logout'; // Capitalize the first letter
        $data['page_title_desc'] = ''; // Capitalize the first letter
	...
	{		
		...
		{	
			...
			{	
				...
				{
					$data['auth_message'] = check('check-success', 'check', '/home');
				}
				else
				{					
					$data['auth_message'] = check('check-success', 'check', '/login');
				}
				
				// Load registration success page
                $data['title'] = 'Registation successful'; // Capitalize the first letter
                $data['page_title'] = 'Registation successful'; // Capitalize the first letter
                $data['page_title_desc'] = ''; // Capitalize the first letter
...
*/
                ...
                $data['page_title_desc'] = 'Here you must register make a account'; // Capitalize the first letter
